...
do
    ...
    do
        ...
        ./$BIN_DIR/do-curl.sh -n 2 --method $m --script $SCRIPT --conf $t.conf
    done
...
paste $TEMPLATE_DIR/fibonacci-numbers ../results/latest/avg-fibonacci-kahvihub.out ../results/latest/avg-fibonacci-node.out ../results/latest/avg-fibonacci-duktape.out >../results/latest/fibonacci.dat

paste $TEMPLATE_DIR/quicksort-numbers ../results/latest/avg-quicksort-kahvihub.out ../results/latest/avg-quicksort-node.out ../results/latest/avg-quicksort-duktape.out >../results/latest/quicksort.dat

paste $TEMPLATE_DIR/newton-numbers ../results/latest/avg-newton-kahvihub.out ../results/latest/avg-newton-node.out ../results/latest/avg-newton-duktape.out >../results/latest/newton.dat
